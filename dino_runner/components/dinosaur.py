import pygame
from dino_runner.utils.constants import DEFAULT_TYPE, DUCKING_SHIELD, JUMPING_SHIELD, RUNNING, DUCKING ,JUMPING, RUNNING_SHIELD, SHIELD, SHIELD_TYPE
        ...
        if self.shield:
            ...
            if time_to_show >= 0:
                if self.show_text:
                    ...
                    text = font.render(f'Shield_enable for [time_to_show]', True, (0, 0, 0))
